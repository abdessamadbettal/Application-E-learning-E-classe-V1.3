...
$resultat = mysqli_query($connecter, "SELECT * FROM students WHERE enroll=$enroll ");
...
if (isset($_POST['save'])) {      // $id = $_POST['id'];
    $name = $_POST['Name'];
    $email = $_POST['Email'];
    $phone = $_POST['Phone'];
    $enroll = $_POST['Enroll'];
    ...
    $result = mysqli_query($connecter, "UPDATE students SET name='$name', email='$email', phone='$phone' , enroll='$enroll' , date='$date'  WHERE enroll=$enroll ");
...
include './footre.php';
// include_once 'model_bootstrap.php' ;
?>
<body>
        <div class="container">
