    ...
    <div class="">
      <div class="d-flex justify-content-between">
        ...
        <div>
          ...
          <!-- <a href="./crud-mysql/add.php" class="btn btn-primary mb-2"> add new student</a> -->
      ...
      <div class="table-responsive ">
        <table class="table table-hover table-striped ">
          <tbody class="border-top-0">
            ...
            <?php
            require_once 'db.php';
            // $query = "SELECT * FROM `student` WHERE enroll between 0 and 999999999; ";
            $query = "SELECT * FROM `students`  ";
            $resultat = mysqli_query($connecter, $query);
            if (mysqli_num_rows($resultat) > 0) {
              $i = 0;
              // while ($row = mysqli_fetch_row($resultat)) $row[0] $row[1]
